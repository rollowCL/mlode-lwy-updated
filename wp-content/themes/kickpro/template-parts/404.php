...
$background_image 	= get_theme_mod( 'header_background_image', $KICKPRO_STORAGE['header_background_image'] );
if($background_image) {
...
$not_found_image 	= get_theme_mod( 'not_found_image', $KICKPRO_STORAGE['not_found_image'] );
if($not_found_image) {
			...
			<div class="row align-items-center">
				<div class="col-md-12">
					<div class="page-header-box">
						<h1><?php echo esc_html__( 'Page not found', 'kickpro' ); ?></h1>
						<?php do_action('kickpro_action_get_breadcrumb'); ?>
					</div>
				</div>
			</div>
		</div>
			...
			<div class="row">
				<div class="col-md-12">
					<div class="error-page-image">
						...
						<?php } else { ?>
							<img src="<?php echo KICKPRO_THEME_URL; ?>/assets/images/404-error-img.png" alt="">
						<?php } ?>
					</div>
					...
					<div class="error-page-content">
						<div class="error-page-content-heading">
							...
							<?php } else { ?>
								<h2><?php echo esc_html__( 'Oops! page not found', 'kickpro' ); ?></h2>
							<?php } ?>
						</div>
						...
						<div class="error-page-content-body">
							...
							<?php } else { ?>
								<p><?php echo esc_html__( 'The page you are looking for does not exist', 'kickpro' ); ?></p>
							<?php } ?>

							<?php
								printf( '<a class="btn-default" href="%s">%s %s</a>', esc_url( home_url() ), __('Back To Homepage','kickpro'), kickpro_render_svg($KICKPRO_STORAGE['read_more_icon']));
							?>
						</div>
					</div>
				</div>
