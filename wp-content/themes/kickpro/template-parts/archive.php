...
$archive_page_layout	=	get_theme_mod( 'archive_page_layout', $KICKPRO_STORAGE['archive_page_layout'] );
				...
				<div class="col-md-12">
					<div class="page-header-box">
						<h1 class="entry-title"><?php 
							$kickpro_blog_title_text = kickpro_get_archive_title();
							echo wp_kses_data( $kickpro_blog_title_text ); ?></h1>
							<?php
									...
									<div class="post-item-body">
										<div class="post-meta">
											<ul>
												...
												<li><i class="fa-regular fa-circle-user"></i><?php the_author(); ?></li>
											</ul>
										</div>
