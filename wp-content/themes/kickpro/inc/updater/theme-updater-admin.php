...
class AWAIKEN_Theme_Updater_Admin {
	...
	public function license_activation_failed_page() {
		?>
		<div class="wrap">
			<h2><?php _e( 'License activation page failed to load', 'kickpro' ); ?></h2>
			<style>
		...
		<p><?php _e( 'Please contact us at our email support@awaiken.com and provide the following details. Our team will assist you in resolving the issue.', 'kickpro' ); ?></p>
		<ol>
			<li><?php _e( 'Item purchase code', 'kickpro' ); ?></li>
			<li><?php _e( 'Server IP address', 'kickpro' ); ?></li>
			<li><?php _e( 'Site URL', 'kickpro' ); ?></li>
		</ol>
		</div>
		<?php 
	}
 ...
 */
function kickpro_theme_admin_notices() {
...
add_action( 'admin_notices', 'kickpro_theme_admin_notices' );
