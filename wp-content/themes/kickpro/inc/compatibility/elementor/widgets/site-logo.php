 ...
 * @since 1.0.0
 */
class kickpro_widget_site_Logo extends Widget_Base {
	...
	public function get_title() {
		return __( 'Kickpro - Site Logo', 'kickpro' );
	}
	...
	protected function register_content_site_logo_controls() {
		...
		$this->add_responsive_control(
			'align',
			array(
				'label'              => __( 'Alignment', 'kickpro' ),
				'type'               => Controls_Manager::CHOOSE,
				'options'            => array(
					'left'   => array(
						'title' => __( 'Left', 'kickpro' ),
						'icon'  => 'eicon-text-align-left',
					),
					'center' => array(
						'title' => __( 'Center', 'kickpro' ),
						'icon'  => 'eicon-text-align-center',
					),
					'right'  => array(
						'title' => __( 'Right', 'kickpro' ),
		...
		$this->add_control(
			'caption',
			array(
				'label'       => __( 'Custom Caption', 'kickpro' ),
				'type'        => Controls_Manager::TEXT,
				'default'     => '',
				'placeholder' => __( 'Enter caption', 'kickpro' ),
				'condition'   => array(
					'caption_source' => 'yes',
				),
				'dynamic'     => array(
		...
		$this->add_control(
			'link_to',
			array(
				'label'   => __( 'Link', 'kickpro' ),
				'type'    => Controls_Manager::SELECT,
				'default' => 'default',
				'options' => array(
					'default' => __( 'Default', 'kickpro' ),
					'none'    => __( 'None', 'kickpro' ),
					'file'    => __( 'Media File', 'kickpro' ),
					'custom'  => __( 'Custom URL', 'kickpro' ),
				),
			)
		);
		...
		$this->add_control(
			...
			array(
				...
				'placeholder' => __( 'https://your-link.com', 'kickpro' ),
				'condition'   => array(
					'link_to' => 'custom',
				),
				'show_label'  => false,
	...
	protected function register_site_logo_styling_controls() {
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Background Color', 'kickpro' ),
		...
		$this->add_control(
			...
			array(
				'label'       => __( 'Border Style', 'kickpro' ),
				'type'        => Controls_Manager::SELECT,
				'default'     => 'none',
				'label_block' => false,
				'options'     => array(
					'none'   => __( 'None', 'kickpro' ),
					'solid'  => __( 'Solid', 'kickpro' ),
					'double' => __( 'Double', 'kickpro' ),
					'dotted' => __( 'Dotted', 'kickpro' ),
					'dashed' => __( 'Dashed', 'kickpro' ),
				),
				'selectors'   => array(
		...
		$this->add_responsive_control(
			'image_border_radius',
			array(
				'label'              => __( 'Border Radius', 'kickpro' ),
				'type'               => Controls_Manager::DIMENSIONS,
				'size_units'         => array( 'px', '%' ),
				'selectors'          => array(
		...
		$this->add_control(
			...
			array(
				'label'     => __( 'Transition Duration', 'kickpro' ),
				'type'      => Controls_Manager::SLIDER,
				'range'     => array(
					'px' => array(
						'max'  => 3,
		...
		$this->add_control(
			'hover_animation',
			array(
				'label' => __( 'Hover Animation', 'kickpro' ),
