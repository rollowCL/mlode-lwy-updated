...
class kickpro_widget_template extends Widget_Base {
	...
	public function get_name() {
		return 'kickpro-elementor-template';
	}

	public function get_title() {
		return __( 'Kickpro - Template', 'kickpro' );
	}
	...
	public function get_keywords() {
		return [ 'kickpro', 'elementor', 'template', 'load' ];
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'section_general',
			[
				'label' => esc_html__( 'General', 'kickpro' ),
			]
		);
		...
		$this->add_control(
			'select_template',
			array(
				'label' => esc_html__( 'Select Template', 'kickpro' ),
