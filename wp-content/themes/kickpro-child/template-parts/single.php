...
while ( have_posts() ) :
	...
	if(empty($secondary_image)) {
		$background_image 	= get_theme_mod( 'blog_page_header_background_image',$KICKPRO_STORAGE['blog_page_header_background_image'] );
		if($background_image) {
			...
			<div class="row">
				...
				<div class="<?php echo esc_attr( $column ); ?>">
					<div class="post-content">
						<div class="post-entry kickpro-block-style">
							<?php the_content(); ?>
							<?php wp_link_pages(); ?>
						</div>
						...
						<div class="row align-items-center">
							<div class="col-lg-8">
								<div class="post-tags">
									<?php the_tags( '<span class="tag-links">' . esc_html__( 'Tags:', 'kickpro' ), '', '</span>' ); ?>
								</div>
							</div>
							<div class="col-lg-4">
								<?php do_action('kickpro_action_social_sharing'); ?>
							</div>
						</div>
					</div>
					<?php 
