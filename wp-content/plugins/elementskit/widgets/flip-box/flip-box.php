...
class ElementsKit_Widget_Flip_Box extends Widget_Base {
    ...
    protected function register_controls() {
		...
		if(has_action( 'ekit/liquid/glass/controls' )) {
			do_action( 'ekit/liquid/glass/controls', $this, '{{WRAPPER}} .ekit-flip-box-front', 'front' );
		}
		...
		if(has_action( 'ekit/liquid/glass/controls' )) {
			do_action( 'ekit/liquid/glass/controls', $this, '{{WRAPPER}} .ekit-flip-box-back', 'back' );
		}
    ...
    protected function render_raw() {
		...
		$ekit_flip_title_tag = \Elementor\Utils::validate_html_tag($ekit_flip_title_tag);
        $ekit_flip_back_title_tag = \Elementor\Utils::validate_html_tag($ekit_flip_back_title_tag);
		...
		$this->add_render_attribute(
			...
			[
				'class' => [
					'ekit-flip-box-front',
					has_filter('ekit/liquid/glass/attr') ? apply_filters('ekit/liquid/glass/attr', $this, 'front') : '',
				]
			]
		);
		...
		$this->add_render_attribute(
			...
			[
				'class' => [
					'ekit-flip-box-back',
					has_filter('ekit/liquid/glass/attr') ? apply_filters('ekit/liquid/glass/attr', $this, 'back') : '',
				]
			]
		);
        ?>
        <div class="ekit-flip-box <?php echo esc_attr($flip_class.$flip_tigger_class.$extra); ?>">
            <div class="ekit-flip-box-inner">
                <div <?php $this->print_render_attribute_string('ekit-flip-box-front'); ?>>
                ...
                <div <?php $this->print_render_attribute_string('ekit-flip-box-back'); ?>>
