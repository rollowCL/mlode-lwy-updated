...
class ElementsKit_Widget_Woo_Mini_Cart extends Widget_Base {
    ...
    protected function render() {
        if(class_exists( 'WooCommerce' )) {
			if ( function_exists( 'wc_load_cart' ) && ! is_object( WC()->cart ) ) {
				wc_load_cart();
			}
            ...
            <div class="ekit-dropdown-back ekit-mini-cart-visibility-<?php echo esc_attr( $settings['ekit_woo_mini_cart_visibility'] ); ?>" data-toggle="mini-cart-dropdown">
                ...
                <div class="ekit-basket-item-count" style="display: inline;">
                    <span class="ekit-cart-items-count count">
                        <?php
							echo ( $cart ? '<span class="ekit-cart-content-count">' . $cart->get_cart_contents_count() . '</span>' : '' );
							echo ( $cart ? '<span class="ekit-cart-content-separator"> - </span>' . $cart->get_cart_total() : '' );
                        ?>
                    </span>
                </div>
                ...
                <div class="ekit-mini-cart-container">
                    <div class="mini-cart-header">
                        <ul>
							<li><span class="ekit-cart-count"><?php echo $cart ? $cart->get_cart_contents_count() : ''; ?></span> <?php esc_html_e( 'items', 'elementskit' ); ?></li>
                            <li><a href="<?php echo esc_url( wc_get_cart_url() ); ?>"><?php esc_html_e( 'view cart', 'elementskit' ); ?></a></li>
                        </ul>
                    </div>
                    <div class="ekit-dropdown-menu ekit-dropdown-menu-mini-cart">
                        <div class="widget_shopping_cart_content">
							<?php $cart ? woocommerce_mini_cart() : ''; ?>
                        </div>
                    </div>
                </div>
            </div>
