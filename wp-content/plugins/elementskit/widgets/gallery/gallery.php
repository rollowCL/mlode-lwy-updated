...
class ElementsKit_Widget_Gallery extends Widget_Base
{
	...
	public function get_script_depends() {
		$deps = ['tilt', 'imagesloaded', 'gallery-filter', 'ekit-pro-gallery'];
    ...
    protected function register_controls()
    {
        ...
        $this->add_control(
            ...
            [
                ...
                'raw' => sprintf(
                    ...
                    esc_html__('Isotope Grid or Masonry Gallery is not supported in the editor. Please preview the page to see the gallery in its actual layout.', 'elementskit'),
                ),
        ...
        $this->add_responsive_control(
            'ekit_gallery_link_icon_line_height',
            [
                ...
                'selectors' => [
                    '{{WRAPPER}} .elementskit-single-portfolio-item .elementskit-gallery-icon' => 'line-height: {{SIZE}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_control(
            ...
            [
                ...
                'options' => [
                    'default'  => esc_html__('Default', 'elementskit'),
                    'style_three' => esc_html__('Style One', 'elementskit'),
                    'style_four' => esc_html__('Style Two', 'elementskit'),
                    'style_five' => esc_html__('Style Three', 'elementskit'),
                    'style_six' => esc_html__('Style Four', 'elementskit'),
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .elementskit_filter_style_four.elementskit_nav_caret > .filter-btn.filter-active::before' => 'width: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .elementskit_filter_style_four.elementskit_nav_caret > .filter-btn.filter-active::before' => 'height: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'ekit_gallery_nav_item_show_caret' => 'yes',
                    'ekit_gallery_filter_style_choose' => ['style_three']
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .elementskit_filter_style_four.elementskit_nav_caret > .filter-btn.filter-active::before' => 'top: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'ekit_gallery_nav_item_show_caret' => 'yes',
                    'ekit_gallery_filter_style_choose' => ['style_three']
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .elementskit_filter_style_three.elementskit_nav_caret > li > a.selected::before, {{WRAPPER}} .elementskit_filter_style_four.elementskit_nav_caret > .filter-btn.filter-active::before',
                'condition' => [
                    'ekit_gallery_nav_item_show_caret' => 'yes',
                    'ekit_gallery_filter_style_choose' => ['style_three']
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .elementskit_filter_style_four.elementskit_nav_caret > .filter-btn.filter-active::after' => 'width: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'ekit_gallery_nav_item_show_caret' => 'yes',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .elementskit_filter_style_four.elementskit_nav_caret > .filter-btn.filter-active::after' => 'height: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'ekit_gallery_nav_item_show_caret' => 'yes',
                    'ekit_gallery_filter_style_choose' => ['style_four']
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .elementskit_filter_style_four.elementskit_nav_caret > .filter-btn.filter-active::after' => 'bottom: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'ekit_gallery_nav_item_show_caret' => 'yes',
                    'ekit_gallery_filter_style_choose' => ['style_four']
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Background', 'elementskit'),
                'types' => ['classic', 'gradient'],
                'selector' => '{{WRAPPER}} .elementskit_filter_style_four.elementskit_nav_caret > li > a.selected::after, {{WRAPPER}} .elementskit_filter_style_four.elementskit_nav_caret > .filter-btn.filter-active::after',
                'condition' => [
                    'ekit_gallery_nav_item_show_caret' => 'yes',
                    'ekit_gallery_filter_style_choose' => ['style_four']
                ],
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Background', 'elementskit'),
                'types' => ['classic', 'gradient'],
                'selector' => '{{WRAPPER}} .elementskit_filter_style_five.elementskit_divider_active > li > a::before, {{WRAPPER}} .elementskit_filter_style_five.elementskit_divider_active > .filter-btn::before, {{WRAPPER}} .elementskit_filter_style_four.elementskit_divider_active > li > a::before, {{WRAPPER}} .elementskit_filter_style_four.elementskit_divider_active > .filter-btn::before',
                'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .elementskit_filter_style_five.elementskit_divider_active > .filter-btn::before' => 'width: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .elementskit_filter_style_four.elementskit_divider_active > li > a::before' => 'width: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .elementskit_filter_style_four.elementskit_divider_active > .filter-btn::before' => 'width: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'ekit_gallery_filter_show_divider' => 'yes',
                    'ekit_gallery_filter_style_choose' => ['style_four', 'style_five'],
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .elementskit_filter_style_five.elementskit_divider_active > .filter-btn::before' => 'height: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .elementskit_filter_style_four.elementskit_divider_active > li > a::before' => 'height: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .elementskit_filter_style_four.elementskit_divider_active > .filter-btn::before' => 'height: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'ekit_gallery_filter_show_divider' => 'yes',
                    'ekit_gallery_filter_style_choose' => ['style_four', 'style_five'],
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Background', 'elementskit'),
                'types' => ['classic', 'gradient'],
                'selector' => '{{WRAPPER}} .elementskit_filter_style_six > li > a.selected > .elementskit_filter_nav_text::before, {{WRAPPER}} .elementskit_filter_style_six > .filter-btn.filter-active > .elementskit_filter_nav_text::before',
                'condition' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .elementskit_filter_style_six > .filter-btn > .elementskit_filter_nav_text::before' => 'width: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'ekit_gallery_filter_style_choose' => ['style_six'],
                ]
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .elementskit_filter_style_six > .filter-btn > .elementskit_filter_nav_text::before' => 'height: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'ekit_gallery_filter_style_choose' => ['style_six'],
                ]
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .elementskit_filter_style_six > .filter-btn > .elementskit_filter_nav_text::before' => 'bottom: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'ekit_gallery_filter_style_choose' => ['style_six'],
                ]
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .elementskit_filter_style_six > .filter-btn > .elementskit_filter_nav_text::before' => 'left: {{SIZE}}{{UNIT}};',
                ],
                'condition' => [
                    'ekit_gallery_filter_style_choose' => ['style_six'],
                ]
        ...
        $this->add_group_control(
            ...
            [
                ...
                {{WRAPPER}} .elementskit-main-filter .filter-btn',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .elementskit-main-filter .filter-btn' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .elementskit-main-filter .filter-btn' => 'background-color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'placeholder' => '1px',
                'default' => '1px',
                'selector' => '{{WRAPPER}} .elementskit-main-filter > li > a, {{WRAPPER}} .elementskit-main-filter .filter-btn',
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .elementskit-main-filter .filter-btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .elementskit-main-filter .filter-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
                ],
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .elementskit-main-filter > li > a.selected,
                                {{WRAPPER}} .elementskit-main-filter .filter-btn.filter-active',
            ]
        );
        ...
        $this->add_group_control(
            ...
            [
                ...
                'selector' => '{{WRAPPER}} .elementskit-main-filter > li > a.selected, {{WRAPPER}} .elementskit-main-filter .filter-btn.filter-active',
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .elementskit-main-filter .filter-btn.filter-active' => 'color: {{VALUE}};',
                ],
            ]
        );
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .elementskit-main-filter .filter-btn.filter-active' => 'background-color: {{VALUE}};',
                ],
                'condition' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => esc_html__('Background', 'elementskit'),
                'types' => ['gradient'],
                'selector' => '{{WRAPPER}} .elementskit-main-filter > li > a.selected .elementskit_blur_shadow_panel,{{WRAPPER}} .elementskit-main-filter > li > a.selected, {{WRAPPER}} .elementskit-main-filter .filter-btn.filter-active',
                'condition' => [
                    'ekit_gallery_filter_style_choose' => 'style_two'
                ],
                'exclude' => [
        ...
        $this->add_responsive_control(
            ...
            [
                ...
                'selectors' => [
                    ...
                    '{{WRAPPER}} .elementskit-main-filter .filter-btn.filter-active' => 'border-color: {{VALUE}};',
                ],
            ]
        );
    ...
    protected function render_raw()
    {
        ...
        $tilt_config = [
            ...
            $col_gap = !empty($settings['ekit_gallery_columns_gap']['size']) ? (int) $settings['ekit_gallery_columns_gap']['size'] : 10;
            $row_gap = !empty($settings['ekit_gallery_rows_gap']['size']) ? (int) $settings['ekit_gallery_rows_gap']['size'] : '';

            $filter_bar_style_class = 'elementskit_filter_' . $settings['ekit_gallery_filter_style_choose']
                . ($settings['ekit_gallery_nav_item_show_caret'] === 'yes' ? ' elementskit_nav_caret' : '')
                . ($settings['ekit_gallery_filter_show_divider'] === 'yes' ? ' elementskit_divider_active' : '');

            $filter_bar_class = 'ekit-filter-bar-wrapper'
                . (!empty($settings['ekit_gallery_nav_alignment']) ? ' ekit-filter-bar-' . $settings['ekit_gallery_nav_alignment'] : '')
                . (!empty($settings['ekit_gallery_fill_nav_content']) ? ' ekit-filter-bar-nav-fill' : '');

            $gallery_config = [
                'layout'                 => $settings['ekit_gallery_style'] === 'masonry' ? 'masonry' : 'grid',
                'showFilters'            => $settings['ekit_gallery_filter_label_show'] === 'yes',
                'allLabel'               => !empty($settings['ekit_gallery_filter_all_label']) ? $settings['ekit_gallery_filter_all_label'] : 'All',
                'columns'                => !empty($settings['ekit_gallery_columns']) ? (int) $settings['ekit_gallery_columns'] : 3,
                'colGap'                 => $col_gap,
                'rowGap'                 => $row_gap !== '' ? $row_gap : $col_gap, // mirrors JS: rowGap !== '' ? rowGap : colGap
                'bentoUnitHeight'        => !empty($settings['ekit_gallery_image_aspect_ratio']['size']) ? (int) ($settings['ekit_gallery_image_aspect_ratio']['size'] * 100) : 140,
                'filterBarClass'         => $filter_bar_class,
                'filterBarBtnGroupClass' => 'elementskit-main-filter ' . $filter_bar_style_class, // pre-merged like the JS
            ];
        ...
        $this->add_render_attribute(
            ...
            [
                ...
                'data-gallery-config' => wp_json_encode($gallery_config),
                'data-tilt-config'  => wp_json_encode($tilt_config),
            ]
        );
        // Add extra class only in Elementor Editor
...
?>
        ...
        ?>
                        <div data-category="<?php echo $item['ekit_gallery_filter_label']; ?>" class="filter-item ekit_gallery_grid_item <?php echo esc_attr($this->clean_class($item['ekit_gallery_filter_label']) . ' ' . $gallery_grid_class); ?>">
