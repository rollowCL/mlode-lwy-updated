...
class ElementsKit_Widget_Google_Map extends Widget_Base {
	...
	public function get_script_depends() {
		return ['ekit-google-map-api', 'ekit-google-gmaps', 'ekit-pro-google-map'];
	}
	...
	<?php if( ! empty($settings['map_type']) ) : ?>
		<div <?php echo $this->get_render_attribute_string('map_wrap'), $this->get_map_render_data_attribute_string($settings); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?>></div>
	<?php endif; ?>
